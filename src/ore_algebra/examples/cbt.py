...
::
    ...
    sage: mat = dop.numerical_transition_matrix([0,s], 1e-30) # long time (1.2 s)
...
We obtain::
    ...
    8  [36.08787528823953523432755657638462582833647717...]
    9  [142.21543933025087303695985127830779667104241...]
